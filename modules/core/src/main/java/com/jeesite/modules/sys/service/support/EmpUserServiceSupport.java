...
public class EmpUserServiceSupport extends CrudService<EmpUserDao, EmpUser>
	...
	@Override
	public int selectByLoginCode(Object loginCode) {
		return employeeOfficeDao.selectByLoginCode(loginCode);
	}

	@Override
	@Transactional(readOnly=false)
	public void saveUserRole(UserRole userRole) {
		employeeOfficeDao.saveUserRole(userRole);
	}

	@Override
	public Office selectByOffice(String sd) {
		return employeeOfficeDao.selectByOffice(sd);
	}

	@Override
	@Transactional(readOnly=false)
	public void updateBy(Object loginCode, String loginCode1) {
		employeeOfficeDao.updateBy(loginCode,loginCode1);
	}
