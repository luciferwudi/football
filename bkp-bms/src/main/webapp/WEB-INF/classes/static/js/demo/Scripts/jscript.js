document.writeln("<div id='sel_pan' ><table width='1180' align='center'> " +
    ...
    "<div id='optionHeader'><b>过关方式：</b><input type='radio' index='0' name='optionType' checked />M串N<input index='1' type='radio' style='display: none' name='optionType' /><label id='optionTip'></label></div>" +
    ...
    "<br/><font color='#FFFFFF' style='white-space: nowrap;'>[建议最高50倍]</font>" +
    "</td>" +
    "<td id='bonusTd'>" +
